...
//                mCacheBitmap=Utils.resizeBitmap(mCacheBitmap,Utils.getWidthandHeight(getContext()).widthPixels,Utils.getWidthandHeight(getContext()).heightPixels);
                ...
                if (mScale != 0) {
                  /*  canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
                    ...
                    canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),new Rect(0,0,(int) (mCacheBitmap.getHeight()*mScale),(int)(mCacheBitmap.getWidth()*mScale)), new Paint());
                } else {
                    /* canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
